...
**A:** $ \Delta z = \epsilon \sqrt{\Delta t} $$ \Delta z $: change in Wiener process; $ \epsilon $: random variable from a standardised normal distribution $ \phi(0, 1) $; $ \Delta t $: small time interval.
...
**A:** $ z(T) - z(0) \sim \phi(0, T) $$ z(T) $: value at time $ T $; $ z(0) $: value at time 0; $ \phi(0, T) $: normal distribution with mean 0 and variance $ T $.
...
**A:** $ dx = a dt + b dz $$ a $: constant drift rate; $ b $: constant volatility; $ dt $: small time increment; $ dz $: Wiener process increment.
...
**A:** $ dx = a(x, t) dt + b(x, t) dz $$ a(x, t) $: drift as a function of $ x $ and $ t $; $ b(x, t) $: volatility as a function of $ x $ and $ t $; $ dz $: Wiener process increment.
...
**A:** $ dS = \mu S dt + \sigma S dz $$ S $: stock price; $ \mu $: expected rate of return; $ \sigma $: volatility; $ dt $: time increment; $ dz $: Wiener process increment.
...
**A:** $ \frac{\Delta S}{S} = \mu \Delta t + \sigma \epsilon \sqrt{\Delta t} $$ \Delta S $: change in stock price; $ S $: current stock price; $ \mu $: expected return; $ \sigma $: volatility; $ \epsilon $: sample from $ \phi(0, 1) $.
...
**A:** $ dG = \left( \frac{\partial G}{\partial x} a + \frac{\partial G}{\partial t} + \frac{1}{2} \frac{\partial^2 G}{\partial x^2} b^2 \right) dt + \frac{\partial G}{\partial x} b dz $$ a, b $: drift and volatility of $ x $; $ G $: function of $ x $ and $ t $; $ dz $: Wiener process.
...
**A:** $ dG = \left( \frac{\partial G}{\partial S} \mu S + \frac{\partial G}{\partial t} + \frac{1}{2} \frac{\partial^2 G}{\partial S^2} \sigma^2 S^2 \right) dt + \frac{\partial G}{\partial S} \sigma S dz $$ \mu $: expected return; $ \sigma $: volatility; $ S $: stock price; $ G $: derivative price.
...
**A:** $ dF = (\mu - r)F dt + \sigma F dz $$ \mu $: stock's expected return; $ r $: risk-free rate; $ \sigma $: volatility; $ F $: forward price; $ dz $: Wiener process.
...
**A:** $ d(\ln S) = (\mu - \frac{\sigma^2}{2}) dt + \sigma dz $$ \mu $: expected return; $ \sigma $: volatility; $ S $: stock price; $ dz $: Wiener process.
...
**A:** $ \ln S_T \sim \phi[ \ln S_0 + (\mu - \frac{\sigma^2}{2})T, \sigma^2 T ] $$ S_T $: price at time $ T $; $ S_0 $: initial price; $ \mu $: expected return; $ \sigma $: volatility.
...
**A:** $ \sigma \sqrt{T} $$ \sigma $: stock volatility; $ T $: time to maturity.
...
**A:** $ \Delta S = \mu S \Delta t + \sigma S \epsilon \sqrt{\Delta t} $This models the absolute change in price as being proportional to the current price level.
...
**A:** $ d(S^n) = [ n\mu + \frac{1}{2} n(n-1)\sigma^2 ] S^n dt + n\sigma S^n dz $$ n $: power; $ \mu $: expected return; $ \sigma $: volatility; $ S $: stock price.
